...
export function generateRateAnalysisPDF({
  ...
  const translations = {
    fr: {
      ...
      advice: "Nos conseils",
      adviceText:
        "Vos tarifs sont compétitifs ! Continuez à développer vos compétences et votre expertise pour augmenter votre valeur sur le marché.",
      footer: "Ce rapport a été généré par PricingPro - https://pricingpro.fr",
    ...
    en: {
      ...
      advice: "Our advice",
      adviceText:
        "Your rates are competitive! Keep developing your skills and expertise to increase your market value.",
      footer: "This report was generated by PricingPro - https://pricingpro.fr",
  ...
  doc.setFontSize(10);
  doc.text(
    `${t.date}: ${new Date().toLocaleDateString(language === "fr" ? "fr-FR" : "en-US")}`,
    pageWidth / 2,
    50,
    { align: "center" },
  );
  ...
  // 1. Liste des professions
  const professions = [
    { value: "web-dev", label: { fr: "Développeur Web", en: "Web Developer" } },
    {
      value: "mobile-dev",
    ...
    { value: "copywriter", label: { fr: "Rédacteur", en: "Copywriter" } },
    {
      value: "marketing",
      label: { fr: "Consultant Marketing", en: "Marketing Consultant" },
    },
    { value: "seo", label: { fr: "Expert SEO", en: "SEO Expert" } },
    {
  ...
  const displayName = selectedProfession
    ? selectedProfession.label[language]
    : formData.profession
      ? formatText(formData.profession)
      : "N/A";

  const profileData = [
    `${t.profession}: ${displayName}`,
    `${t.location}: ${formatText(formData.location)}`,
  ...
  doc.setFont("helvetica", "normal");
  doc.text(t.hourly, 15 + rateBoxWidth / 2, yPosition + 10, {
    align: "center",
  });
  ...
  doc.setTextColor(...primaryColor);
  doc.setFont("helvetica", "bold");
  doc.text(`${results.hourly}€`, 15 + rateBoxWidth / 2, yPosition + 25, {
    align: "center",
  });
  ...
  doc.setTextColor(255, 255, 255);
  doc.setFont("helvetica", "normal");
  doc.text(t.daily, 20 + rateBoxWidth + rateBoxWidth / 2, yPosition + 10, {
    align: "center",
  });
  ...
  doc.text(
    `${results.daily}€`,
    20 + rateBoxWidth + rateBoxWidth / 2,
    yPosition + 25,
    { align: "center" },
  );
  ...
  doc.text(
    t.monthly,
    25 + 2 * rateBoxWidth + rateBoxWidth / 2,
    yPosition + 10,
    { align: "center" },
  );
  ...
  const marketData = [
    {
      label: t.marketMin,
      value: `${results.market.min}€/j`,
      color: [239, 68, 68],
    },
    {
      label: t.marketAvg,
      value: `${results.market.avg}€/j`,
      color: [234, 179, 8],
    },
    { label: t.yourRate, value: `${results.daily}€/j`, color: primaryColor },
    {
      label: t.marketMax,
      value: `${results.market.max}€/j`,
      color: [34, 197, 94],
    },
  ];
  ...
  // =========================================================
  // === PAGE POUR DÉTAIL DU CALCUL ET CONSEILS ===
  // =========================================================
  doc.addPage();
  yPosition = 20;
  ...
  doc.text(`${results.daily}€/jour`, pageWidth - 25, breakdownY, {
    align: "right",
  });
  ...
  if (results.dataSource === "real" && results.sourceCount) {
    ...
    doc.text(
      `${t.dataSource} ${results.sourceCount} ${t.realData}`,
      24,
      yPosition,
    );
  }
