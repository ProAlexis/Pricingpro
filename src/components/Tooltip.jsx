  ...
  profession: {
    fr: (
      <div>
        ...
        <p>Votre profession détermine le tarif de base du marché. Nous analysons 1000+ tarifs réels pour chaque métier.</p>
      </div>
    ),
    en: (
      <div>
        <p className="font-semibold mb-1">Why is this important?</p>
        <p>Your profession determines the base market rate. We analyze 1000+ real rates for each profession.</p>
      </div>
    )
  },
  location: {
    fr: (
      <div>
        ...
        <p>Les tarifs varient selon les pays et les villes. Paris = +20%, Lisbonne = -30%, Londres = +30%.</p>
      </div>
    ),
    en: (
      <div>
        <p className="font-semibold mb-1">Geographic impact</p>
        <p>Rates vary by country and city. Paris = +20%, Lisbon = -30%, London = +30%.</p>
      </div>
    )
  },
  experience: {
    fr: (
      <div>
        ...
        <p>Chaque année d'expérience augmente votre valeur de ~8%. Soyez honnête pour obtenir un tarif réaliste.</p>
      </div>
    ),
    en: (
      <div>
        <p className="font-semibold mb-1">Years of experience</p>
        <p>Each year of experience increases your value by ~8%. Be honest to get a realistic rate.</p>
      </div>
    )
  },
  experienceLevel: {
    fr: (
      <div>
        ...
        <ul className="space-y-1 text-xs mt-2">
          <li>• <strong>Junior:</strong> 0-2 ans, apprentissage</li>
          <li>• <strong>Confirmé:</strong> 3-7 ans, autonome</li>
          <li>• <strong>Senior:</strong> 8+ ans, expert reconnu</li>
        </ul>
      </div>
    ),
    en: (
      <div>
        ...
        <ul className="space-y-1 text-xs mt-2">
          <li>• <strong>Junior:</strong> 0-2 years, learning</li>
          <li>• <strong>Mid-level:</strong> 3-7 years, autonomous</li>
          <li>• <strong>Senior:</strong> 8+ years, recognized expert</li>
        </ul>
      </div>
    )
  },
  skills: {
    fr: (
      <div>
        ...
        <p>Chaque compétence rare ou demandée ajoute +30€/jour à votre tarif. Listez celles qui vous différencient.</p>
      </div>
    ),
    en: (
      <div>
        <p className="font-semibold mb-1">Valued skills</p>
        <p>Each rare or in-demand skill adds +€30/day to your rate. List those that differentiate you.</p>
      </div>
    )
  },
  legalStatus: {
    fr: (
      <div>
        ...
        <ul className="space-y-1 text-xs mt-2">
          <li>• <strong>Auto-entrepreneur:</strong> ~22% de charges</li>
          <li>• <strong>SASU:</strong> ~54% de charges totales</li>
          <li>• <strong>EURL:</strong> ~45% de charges TNS</li>
          <li>• <strong>Portage:</strong> ~49% tout inclus</li>
        </ul>
      </div>
    ),
    en: (
      <div>
        ...
        <ul className="space-y-1 text-xs mt-2">
          <li>• <strong>Self-employed:</strong> ~22% contributions</li>
          <li>• <strong>SASU:</strong> ~54% total contributions</li>
          <li>• <strong>EURL:</strong> ~45% TNS contributions</li>
          <li>• <strong>Umbrella:</strong> ~49% all inclusive</li>
        </ul>
      </div>
    )
  }
