...
const Footer = ({ language = 'fr' }) => {
  const t = {
    ...
    allProfessions: language === 'fr' ? 'Voir tous les métiers →' : 'See all professions →',
    ...
    copyright: language === 'fr' ? 'Tous droits réservés.' : 'All rights reserved.',
  };
    ...
    <footer className="bg-gray-900 text-gray-300 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="pt-4">
                <Link to={legalUrls.legal} className="hover:text-purple-400 transition-colors">
                  {t.legal}
                </Link>
              </li>
              <li>
                <Link to={legalUrls.privacy} className="hover:text-purple-400 transition-colors">
                  {t.privacy}
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-500">
          <p>© 2026 PricingPro. {t.copyright}</p>
        </div>
      </div>
    </footer>
  );
