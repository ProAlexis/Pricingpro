...
const ProfessionTemplate = () => {
  ...
  useEffect(() => {
    // On cherche dans tes données quelle profession correspond au slug de l'URL
  ...
  if (!foundKey) return <div className="text-center p-20 text-white">404 - Métier non trouvé</div>;

  // --- C'EST ICI QUE LA MAGIE OPÈRE ---
  // Au lieu de réécrire le HTML, on appelle ton composant original "ProfessionPage"
  // en lui passant les bonnes infos dynamiquement.
  return (
    <ProfessionPage 
      profession={professionsData[foundKey]} // On passe l'objet complet (comme avant)
